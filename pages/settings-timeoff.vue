<template>
    <div class="div">
                    ...
                    <div class="col-xl-12 col-sm-12 col-12 ">
                        <div class="row">
                            <div class="col-xl-6 col-sm-12 col-12  d-flex">
                                <div class="card card-lists flex-fill">
                                    <div class="card-header ">
                                        ...
                                        <a data-toggle="modal" data-target="#add_company" class="edit-link"> <i
                            ...
                            <div class="col-xl-6 col-sm-12 col-12 d-flex">
                                <div class="card card-lists flex-fill">
                                    <div class="card-header ">
                                        <h2 class="card-titles">Working Week<span>Set the dates that your company
                                                works.</span></h2>
                                        <a data-toggle="modal" data-target="#edit_working" class="edit-link"> <i
                                                data-feather="edit"></i></a>
                                    </div>
                                    <div class="card-body">
                                        <div class="form-week">
                    ...
                    <div class="col-xl-12 col-sm-12 col-12 ">
                        <div class="row">
                            <div class="col-xl-6 col-sm-12 col-12 d-flex">
                                <div class="card card-lists flex-fill">
                                    <div class="card-header ">
                                        <h2 class="card-titles">Working From Home<span>Reflect your company's working from
                                                home policy by editing the approval process or disabling the feature
                                                entirely.</span></h2>
                                    </div>
                                    <div class="card-body">
                                                        ...
                                                        <td>
                                                            <div class="table-img">
                                                                <img src="assets/img/profiles/avatar-15.jpg"
                                                                    class="img-table" alt="profile"><label>Rizal Haris</label>
                                                            </div>
                                                        </td>
                                                        <td><label>25</label></td>
                                                        <td><label>20 </label></td>
                                                        <td><label>Azzahra Syarah</label></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
        ...
        <div class="customize_popup">
            <div class="modal fade" id="add_company" tabindex="-1" aria-labelledby="staticBackdropLabeladd"
                aria-hidden="true">
        ...
        <div class="customize_popup">
            <div class="modal fade" id="edit_working" tabindex="-1" aria-labelledby="staticBackdropLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
