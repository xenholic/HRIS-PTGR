                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="active nav-link" id="tabdetails" data-toggle="tab" href="#details" role="tab"
                                        aria-controls="details" aria-selected="true">Manage Details</a>
                                </li>
                                <li>
                                    <a class="nav-link" id="tabtimeoff" data-toggle="tab" href="#timeoff" role="tab"
                                        aria-controls="timeoff" aria-selected="false">Manage Time Off</a>
                                </li>
                                <li>
                                    <a class="nav-link" id="tabsalaries" data-toggle="tab" href="#salaries" role="tab"
                                        aria-controls="salaries" aria-selected="false">Manage Salaries</a>
                                </li>
                                <li>
                                    <a class="nav-link" id="tabmanageall" data-toggle="tab" href="#manageall" role="tab"
                                        aria-controls="manageall" aria-selected="false">Manage All</a>
                                </li>
                                <li>
                                    <a class="nav-link" id="tabsettings" data-toggle="tab" href="#settings" role="tab"
                                        aria-controls="settings" aria-selected="false">Manage All</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">Nationality, full date of birth, and
                                                                    home address </p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">
                                                                    Keep track of important occasions for people in your
                                                                    team. Such as start date, probation date, or visa
                                                                    expiration
                                                                </p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">
                                                                    Create and manage all date types that can be applied to
                                            ...
                                            <table class="table  custom-table  no-footer tablenoheader">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">Manage time off requests for anyone
                                                                    in their team. </p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <span>Adjust the holiday allowance for people in their team
                                                                </span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                <h6 class="mb-0">Manage Time Off settings for The Company
                                                                </h6>
                                                                <span>
                                                                    Manage custom leave types, roll over, company holidays
                                                                    and restricted days, the company working week, and your
                                                                    company holiday allowance.
                                                                </span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">
                                                                    Create, edit, or delete working from home requests for
                                    ...
                                    <div class="tab-pane fade" id="manageall" role="tabpanel"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">View or manage future starters at
                                                                    your company that will join their team </p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="custom-control custom-switch">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">Archive everyone else and revoke
                                                                    their access</p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">Edit and assign Roles to anyone in
                                                                    the company</p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">Can move people in or out of their
                                                                    team</p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">Set your company name, logo, mission,
                                                                    and cover photo</p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">
                                                                    Create, edit, and delete the slides shown to new
                                                                    starters when they first join .
                                                                </p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">
                                                                    Add, update and remove tools from the company tools
                                                                    section
                                                                </p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">
                                                                    Manage the Slack integration, including automating slack
                                                                    accounts for new starters, and customizing notifications
                                                                </p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                <p class="ctm-text-sm">Ability to disable the calendar
                                                                    integration for everyone </p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="custom-control custom-switch">
