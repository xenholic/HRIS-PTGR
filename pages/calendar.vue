                                ...
                                <div class="calendar_events">
                                    ...
                                    <div id="calendar-events" class="mb-3">
                                        <div class="calendar-events" data-class="bg-info"><i
                                                class="fas fa-square bg-primary"></i> New Theme Release</div>
                                        <div class="calendar-events" data-class="bg-success"><i
                                                class="fas fa-square bg-success"></i>My Event</div>
                                        <div class="calendar-events" data-class="bg-danger"><i
                                                class="fas fa-square bg-warning"></i> Meet Manager</div>
                                        <div class="calendar-events" data-class="bg-warning"><i
                                                class="fas fa-square bg-secondary"></i> Create New theme</div>
                                    </div>
