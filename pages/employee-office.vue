        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-xl-1 col-sm-2 col-12 ">
                        <a href="/employee" class="btn-view "><i data-feather="list"></i> </a>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-12 col-sm-12 col-12 ">
                        <div class="card">
                            <div class="card-header create-formhead">
                                ...
                                <a data-toggle="modal" data-target="#edit" class="edit-link"><i data-feather="edit"></i>
                                </a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table  custom-table  no-footer">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><label>PT Greenland Resource</label></td>
                                                <td><label>Team Lead</label></td>
                                                <td class="tab-select">
                                                    <select class="select">
                                                        <option value="active">Active</option>
