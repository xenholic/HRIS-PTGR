          ...
          <div class="col-xl-6 col-sm-12 col-12 d-flex	">
            <div class="card card-lists flex-fill">
              <div class="card-header">
                <h2 class="card-titles">PT Greenland Resource<span>Head Office</span></h2>
            ...
            <div class="card flex-fill">
              <div class="card-body">
                <div class="employee_status text-center">
                  ...
                  <label>John Gibbs is Working <br>from office today.</label>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <table class="table  custom-table  no-footer">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="table-img">
                            <a href="profile.html"><img src="assets/img/profiles/avatar-13.jpg" alt="profile"
                                class="img-table"></a>
                        ...
                        <td>
                          <label><a class="action_label4" data-toggle="modal" data-target="#delete">Delete <i
                      ...
                      <tr>
                        <td>
                          <div class="table-img">
                            <a href="profile.html"><img src="assets/img/profiles/avatar-16.jpg" alt="profile"
                                class="img-table"></a>
                      ...
                      <tr>
                        <td>
                          <div class="table-img">
                            <a href="profile.html"><img src="assets/img/profiles/avatar-17.jpg" alt="profile"
                                class="img-table"></a>
