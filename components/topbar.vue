      ...
      <div class="gap-2">
        ...
        <div id="dropdownNotification"
          ...
          <div class="divide-y divide-gray-100 dark:divide-gray-700">
            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
              ...
              <div class="w-full ps-3">
                <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400">
                  New message from
                  <span class="font-semibold text-gray-900 dark:text-white">Jese Leos</span>: "Hey, what's up? All set for
                  the presentation?"
                </div>
            ...
            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
              <div class="flex-shrink-0">
                <img class="rounded-full w-11 h-11" src="../assets/img/avatar.png" alt="Joseph image" />
                <div
            ...
            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
              <div class="flex-shrink-0">
                <img class="rounded-full w-11 h-11" src="../assets/img/avatar.png" alt="Bonnie image" />
                <div
            ...
            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
              <div class="flex-shrink-0">
                <img class="rounded-full w-11 h-11" src="../assets/img/avatar.png" alt="Leslie image" />
                <div
            ...
            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
              <div class="flex-shrink-0">
                <img class="rounded-full w-11 h-11" src="../assets/img/avatar.png" alt="Robert image" />
                <div
      ...
      <div>
        ...
        <div id="dropdownAvatar"
          ...
          <div class="px-4 py-3 text-sm text-gray-900 dark:text-white">
            <div>Andri</div>
            <div class="font-medium truncate">Andri@ptgr.co.id</div>
          </div>
